...
export function SearchBar() {
  ...
  return (
    <div className="flex">
      <form className="flex flex-1 items-center gap-x-4 border-b-4 border-b-blue-900 border-opacity-300 h-20">
        <div className={`flex items-center w-3/6`}>
          <input
            type="text"
            name="filter"
            className="w-full rounded-xl px-3 py-2"
            placeholder="Search a title or creator"
          />
          <svg
      ...
      <form
        action="/logout"
        method="post"
        className="flex items-center gap-x-4 border-b-4 border-b-blue-900 border-opacity-300 h-20"
      >
